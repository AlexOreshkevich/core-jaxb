 ...
 */
package by.prognoz.exjaxb.parser;
...
public interface ExJAXBParser<T> {
  ...
  /**
   * ExJAXBParser должен предоставить сведения о пользовательских простанствах имен
   * Если возвращается null, то используется карта по умолчанию
   * 
